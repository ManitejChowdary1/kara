        ...
        <div className="founders-grid">
          ...
          <div className="founder-profile-card animate-slide-up delay-4">
            <div className="founder-img-wrapper">
              <img src={cofounder} alt="Narmada Gorremuchu - Founder & Creative Director" className="founder-img" />
            </div>
            <div className="founder-info">
              ...
              <p className="founder-bio">
                Narmada Gorremuchu (founder of Else Boutique) is an acclaimed fashion designer and creative director specializing in couture bridal wear, premium styling, and creating breathtaking wedding designs.
              </p>
            </div>
          </div>
          ...
          <div className="founder-profile-card animate-slide-up delay-5">
            <div className="founder-img-wrapper">
              <img src={founder} alt="Pradeep Sagar - Co-Founder & Lead Curator" className="founder-img" />
            </div>
            <div className="founder-info">
              <span className="badge" style={{ marginBottom: "16px", fontSize: "0.75rem", padding: "4px 12px" }}>
                The Visionary
              ...
              <h5 className="founder-title">Co-Founder & Lead Curator</h5>
              <p className="founder-bio">
                Pradeep Sagar is a highly acclaimed professional photographer and event curator specializing in capturing life's finest moments and directing premium high-end events.
              </p>
            </div>
          </div>
        </div>
